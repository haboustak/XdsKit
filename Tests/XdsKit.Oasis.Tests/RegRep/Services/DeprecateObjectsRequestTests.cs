...
{
    [TestFixture]
    public class DeprecateObjectsRequestTests
    {
        [Test]
        public void Should_Deserialize_Test01()
        {
            var request = Resource.Deserialize<DeprecateObjectsRequest>("Resources.Services.DeprecateObjectsRequest_Test01.xml");
        ...
        public void Should_Serialize_Test01()
        {
            ...
            list.ToXml()
                .AssertByLine(XDocument.Parse(Resource.Get("Resources.Services.DeprecateObjectsRequest_Test01.xml")));
        }
        ...
        public void Should_Parse_Serialized_Test01()
        {
            ...
            var list2 = xml.FromXml<DeprecateObjectsRequest>();
            list.DeepEquals(list2);
        }

        public DeprecateObjectsRequest Build_Test01()
        {
            var item = new DeprecateObjectsRequest
            {
                Id = "urn:xdskit:com:c7ptmx37tfbcwy8ky7a",
                Comment = "Deprecate these documents",
