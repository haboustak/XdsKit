...
{
    [TestFixture]
    public class UndeprecateObjectsRequestTests
    {
        [Test]
        public void Should_Deserialize_Test01()
        {
            var request = Resource.Deserialize<UndeprecateObjectsRequest>("Resources.Services.UndeprecateObjectsRequest_Test01.xml");
        ...
        public void Should_Serialize_Test01()
        {
            ...
            list.ToXml()
                .AssertByLine(XDocument.Parse(Resource.Get("Resources.Services.UndeprecateObjectsRequest_Test01.xml")));
        }
        ...
        public void Should_Parse_Serialized_Test01()
        {
            ...
            var list2 = xml.FromXml<UndeprecateObjectsRequest>();
            list.DeepEquals(list2);
        }

        public UndeprecateObjectsRequest Build_Test01()
        {
            var item = new UndeprecateObjectsRequest
            {
                Id = "urn:xdskit:com:c7ptmx37tfbcwy8ky7a",
                Comment = "Undeprecate these documents",
