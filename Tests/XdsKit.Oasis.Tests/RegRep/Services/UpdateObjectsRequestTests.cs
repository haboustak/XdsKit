...
{
    [TestFixture]
    public class UpdateObjectsRequestTests
    {
        [Test]
        ...
        public void Should_Serialize_Test01()
        {
            ...
            list.ToXml()
                .AssertByLine(XDocument.Parse(Resource.Get("Resources.Services.UpdateObjectsRequest_Test01.xml")));
        }
        ...
        public void Should_Parse_Serialized_Test01()
        {
            ...
            var list2 = xml.FromXml<UpdateObjectsRequest>();
            list.DeepEquals(list2);
        }

        private UpdateObjectsRequest Build_Test01()
        {
            var request = new UpdateObjectsRequest
            {
