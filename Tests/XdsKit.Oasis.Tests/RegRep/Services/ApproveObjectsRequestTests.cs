...
{
    [TestFixture]
    public class ApproveObjectsRequestTests
    {
        [Test]
        public void Should_Deserialize_Test01()
        {
            var request = Resource.Deserialize<ApproveObjectsRequest>("Resources.Services.ApproveObjectsRequest_Test01.xml");
        ...
        public void Should_Serialize_Test01()
        {
            ...
            list.ToXml()
                .AssertByLine(XDocument.Parse(Resource.Get("Resources.Services.ApproveObjectsRequest_Test01.xml")));
        }
        ...
        public void Should_Parse_Serialized_Test01()
        {
            ...
            var list2 = xml.FromXml<ApproveObjectsRequest>();
            list.DeepEquals(list2);
        }

        public ApproveObjectsRequest Build_Test01()
        {
            var item = new ApproveObjectsRequest
            {
                Id = "urn:xdskit:com:c7ptmx37tfbcwy8ky7a",
                Comment = "There are not many real-world ebXml regrep examples on the internet",
